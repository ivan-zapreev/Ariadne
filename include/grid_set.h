...
class GridTreeSubset : public DrawableInterface {
  ...
  public:
    ...
    /*! \brief Tests if a %GridTreeSubset is a subset of another %GridTreeSubset. */
    tribool subset( const GridTreeSubset& other ) const;

    /*! \brief Tests if a %GridTreeSubset is a superset of a box. */
    tribool superset( const GridTreeSubset& other ) const;

    /*! \brief Tests if (the closure of) a %GridTreeSubset is disjoint from another %GridTreeSubset. */
    tribool disjoint( const GridTreeSubset& other  ) const;

    /*! \brief Tests if a %GridTreeSubset overlaps another %GridTreeSubset. */
    tribool overlaps( const GridTreeSubset& other ) const;
...
class GridTreeSet : public GridTreeSubset {
  protected:
    ...
    static void _outer_restrict( const Grid & theGrid, BinaryTreeNode * pBinaryTreeNode, const uint primary_cell_height,
    ...
    static void _inner_restrict( const Grid & theGrid, BinaryTreeNode * pBinaryTreeNode, const uint primary_cell_height,
                                 const uint max_mince_depth,  const SetCheckerInterface& checker, BinaryWord * pPath );

    static void _inner_restrict( const Grid & theGrid, BinaryTreeNode * pBinaryTreeNode, const uint primary_cell_height,
                                 const uint max_mince_depth,  const OpenSetInterface& set, BinaryWord * pPath );

    static void _outer_remove( const Grid & theGrid, BinaryTreeNode * pBinaryTreeNode, const uint primary_cell_height,
                                 const uint max_mince_depth,  const SetCheckerInterface& checker, BinaryWord * pPath );
    ...
    static void _inner_remove( const Grid & theGrid, BinaryTreeNode * pBinaryTreeNode, const uint primary_cell_height,
                                 const uint max_mince_depth,  const SetCheckerInterface& checker, BinaryWord * pPath );
...
//! \brief The outer approximation of the intersection between \a grid_set and \a cons_set.
GridTreeSet outer_intersection(const GridTreeSet& grid_set, const ConstraintSet& cons_set);
//! \brief The inner approximation of the intersection between \a grid_set and \a cons_set.
GridTreeSet inner_intersection(const GridTreeSet& grid_set, const ConstraintSet& cons_set);
//! \brief The outer approximation of the difference between \a grid_set and \a cons_set.
GridTreeSet outer_difference(const GridTreeSet& grid_set, const ConstraintSet& cons_set);
//! \brief The inner approximation of the difference between \a grid_set and \a cons_set.
