...
void test_constraintset_vs_gridtreeset_operations()
{
	...
	ARIADNE_TEST_EQUAL(outer_intersection(gts1,cons).bounding_box(),Box(1, -1.0,2.0));
	ARIADNE_TEST_EQUAL(inner_intersection(gts1,cons).size(),0);
	...
	ARIADNE_TEST_EQUAL(outer_intersection(gts2,cons).size(),1);
	ARIADNE_TEST_EQUAL(inner_intersection(gts2,cons).size(),0);
	...
	ARIADNE_TEST_EQUAL(outer_intersection(gts3,cons).bounding_box(),gts3.bounding_box());
	ARIADNE_TEST_EQUAL(inner_intersection(gts3,cons).size(),1);
	...
	ARIADNE_TEST_EQUAL(outer_intersection(gts4,cons).size(),3);
	ARIADNE_TEST_EQUAL(inner_intersection(gts4,cons).size(),3);
...
void test_restriction_difference() {
    ...
    plot("test_grid_set_restriction_is1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set1);
    ...
    GridTreeSet set3(3, true);
    ARIADNE_TEST_FAIL(set3.outer_restrict(cs1));    
    ARIADNE_TEST_FAIL(set0.outer_restrict(checker1, 2));
    GridTreeSet set2(2, false); 
    ...
    set2 = set1;
    set2.outer_restrict(cs1);
    plot("test_grid_set_outer_restrict_cs1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set2);
    ...
    plot("test_grid_set_outer_restrict_checker1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set3);
    ...
    set2.inner_restrict(cs1);
    ARIADNE_TEST_ASSERT(!set2.empty());
    plot("test_grid_set_inner_restrict_cs1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set2);
    ARIADNE_TEST_ASSERT(set2.bounding_box().inside(Box(2, -1.0,9.5, -1.0,9.5)));
    ARIADNE_TEST_ASSERT(set2.subset(set1));
    ARIADNE_TEST_ASSERT(!set1.subset(set2));
    set3 = set1;
    set3.inner_restrict(checker1, 2);
    plot("test_grid_set_inner_restrict_checker1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set3);
    ARIADNE_TEST_EQUAL(set2, set3);
    ...
    set2 = set1;
    set2.outer_remove(cs1);
    plot("test_grid_set_outer_remove_cs1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set2);
    GridTreeSet set4(2);
    set4.adjoin_outer_approximation(set1.cell().box(), 2);
    set4.outer_restrict(cs1);
    set4 = difference(set1, set4);
    ARIADNE_TEST_ASSERT(set2.subset(set4));
    ARIADNE_TEST_ASSERT(set4.subset(set2));
    set3 = set1;
    set3.outer_remove(checker1, 2);
    plot("test_grid_set_outer_remove_checker1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set3);
    ARIADNE_TEST_EQUAL(set2, set3);
    ...
    set2.inner_remove(cs1);
    ARIADNE_TEST_ASSERT(!set2.empty());
    plot("test_grid_set_inner_remove_cs1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set2);
    set4.clear();
    set4.adjoin_outer_approximation(set1.cell().box(), 2);
    ...
    plot("test_grid_set_inner_remove_checker1",PlanarProjectionMap(2,0,1),set1.bounding_box(),Colour(1,0,1),set3);
    ARIADNE_TEST_EQUAL(set2, set3);
